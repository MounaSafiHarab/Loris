...
if ($result) {
	...
	$upload_id=$row['ProcessID'];
     ...
     // Strlen can not exceed 25 so for phantoms this might be a problem; so take last 25 chars
       ...
       $username	= ''; // enter URL uername here	 
       $password	= ''; // enter URL password here

       //$url = 'https://spred.braincode.ca/xtxnotify'; // not setup yet
       $url = 'http://52.33.47.62/notify/'; // test URL from Mark for testing
       ...
       curl_setopt($ch, CURLOPT_USERPWD, '$usename:$password');
